...
class API_Manager_Vizio_theme_MENU {
	...
	public function wc_am_api_key_field() {
		...
		if ( AMET()->ame_options[AMET()->ame_api_key] ) {
			echo "<span class='icon-pos'><img src='" . AMET()->theme_url() . "sp-framework/am/assets/images/complete.png' title='' style='padding-bottom: 4px; vertical-align: middle; margin-right:3px;' /></span>";
		} else {
			echo "<span class='icon-pos'><img src='" . AMET()->theme_url() . "sp-framework/am/assets/images/warn.png' title='' style='padding-bottom: 4px; vertical-align: middle; margin-right:3px;' /></span>";
		}
	}
